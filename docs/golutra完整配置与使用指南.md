...
**相关文档**：
- [Worker 配置与 Skills 实操手册](Worker配置与Skills实操手册.md) —— ⭐ 三层架构、Skill 是什么、规则体系、完整协作流程
- [配置 FAQ：4 个常见问题详解](配置FAQ-4个常见问题详解.md) —— 技术栈探测、Worker 互知、全局配置、手把手配置教程
- [技术栈探测员 Worker 文档](workers/技术栈探测员.md) —— 专门探测项目技术栈并广播的 Worker
